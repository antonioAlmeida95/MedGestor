...
namespace MedGestor.Adapter.Driven.Database.Migrations
{
    ...
    [Migration("20250208211111_Inclusao_Entidade_Consulta")]
    partial class Inclusao_Entidade_Consulta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedGestor.Core.Domain.Entities.Consulta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Cst_Consulta", "MedHealth");
                });
            ...
            modelBuilder.Entity("MedGestor.Core.Domain.Entities.Consulta", b =>
                {
                    b.HasOne("MedGestor.Core.Domain.Entities.Agenda", "Agenda")
                        .WithMany("Consultas")
                        .HasForeignKey("AgendaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedGestor.Core.Domain.Entities.Paciente", "Paciente")
                        .WithMany("Consultas")
